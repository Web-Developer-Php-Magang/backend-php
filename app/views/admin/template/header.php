            ...
            <ul class="nav user-menu">
                <li class="nav-item dropdown noti-dropdown language-drop me-2">
                    <a href="#" class="dropdown-toggle nav-link header-nav-list" data-bs-toggle="dropdown">
                        <img src="<?= BASE_URL ?>assets/img/icons/header-icon-01.svg" alt="">
                    </a>
                ...
                <li class="nav-item dropdown has-arrow new-user-menus">
                    <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <span class="user-img">
                            <img class="rounded-circle" src="<?= BASE_URL ?>assets/img/profiles/avatar-01.jpg" width="31" alt="Soeng Souy">
                            <div class="user-text">
                                <h6>Soeng Souy</h6>
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li><a href="<?= BASE_URL ?>admin/department">Department List</a></li>
                                <li><a href="<?= BASE_URL ?>admin/department/add_department">Department Add</a></li>
                                <li><a href="<?= BASE_URL ?>admin/department/edit_department">Department Edit</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
